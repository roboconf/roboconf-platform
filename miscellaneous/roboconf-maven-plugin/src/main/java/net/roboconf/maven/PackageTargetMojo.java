 ...
 */
@Mojo( name="package-target", defaultPhase = LifecyclePhase.PACKAGE )
public class PackageTargetMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		try {
			this.zipArchiver.addDirectory( outputDirectory );
