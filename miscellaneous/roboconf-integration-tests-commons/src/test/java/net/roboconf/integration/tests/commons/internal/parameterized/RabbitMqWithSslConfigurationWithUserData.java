 ...
 */
public class RabbitMqWithSslConfigurationWithUserData extends RabbitMqWithSslConfigurationWithoutUserData {

	@Override
	public List<Option> options() {

		// SSL configuration is passed as user data
		List<Option> options = super.options();
