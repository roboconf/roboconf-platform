 ...
 */
public class AbstractMessageProcessorDmTest {

	@Test
	public void testCreation_valid() throws Exception {

		String name = MessagingConstants.FACTORY_TEST;
		AbstractMessageProcessorDm processor = new AbstractMessageProcessorDm( name ) {
		...
		IDmClient client = processor.createNewMessagingClient( messageServerIp, messageServerUser, messageServerPwd );
