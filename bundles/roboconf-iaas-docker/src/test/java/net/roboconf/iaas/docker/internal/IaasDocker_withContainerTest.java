 ...
 */
public class IaasDocker_withContainerTest {
	...
	public void testValidConfiguration() throws Exception {
		...
		Assume.assumeTrue( this.dockerIsInstalled );
		Map<String, String> iaasProperties = loadIaasProperties();
	...
	public void testCreateAndTerminateVM() throws Exception {
		...
		Assume.assumeTrue( this.dockerIsInstalled );
		IaasDocker iaas = new IaasDocker();
		iaas.setIaasProperties( loadIaasProperties());
	...
	/**
	 * Loads IaaS properties for the configuration of Docker.
	 */
	private Map<String,String> loadIaasProperties() throws Exception {
		...
		if( this.dockerImageId != null )
			iaasProperties.put( DockerConstants.IMAGE_ID, this.dockerImageId );
