...
package net.roboconf.agent.api;
...
import net.roboconf.agent.api.internal.AgentConstants;
import net.roboconf.agent.api.internal.AgentMessageProcessor;
import net.roboconf.agent.api.internal.AgentProperties;
...
public abstract class AbstractAgent implements IAgent {
	...
	protected boolean simulatePlugins = false, overrideProperties = true;
	...
	/* (non-Javadoc)
	 * @see net.roboconf.agent.api.api.IAgent#start()
	 */
	@Override
	public void start() {
	...
	/* (non-Javadoc)
	 * @see net.roboconf.agent.api.api.IAgent#stop()
	 */
	@Override
	public void stop() {
