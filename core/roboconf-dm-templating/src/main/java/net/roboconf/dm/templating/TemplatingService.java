...
/**
 * Interface for templating management.
 * @author Pierre Bourret - Université Joseph Fourier
 */
public interface TemplatingService {

	/**
	 * The name of the directory where application templates are read from,
	 * relative to the Roboconf configuration directory.
	 */
	...
	/**
	 * Gets the target directory, where reports are generated.
	...
	/**
	 * Gets the current list of the templates for a given application.
	 * <p>
	 ...
	 * </p>
	 *
	 * @param application the application scope for the template to list, or {@code null} to list global templates only.
	 * @return the current list of the templates. The returned list is an immutable snapshot.
	 */
	...
	/**
	 * Removes a template.
	 * @param application the application scope for the template to remove, or {@code null} to remove a global template.
	 * @param name the name of the template to remove.
	 * @return {@code true} is the template was successfully removed, {@code false} if there was no template with such a name.
