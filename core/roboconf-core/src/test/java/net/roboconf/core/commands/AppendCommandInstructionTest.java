 ...
 */
public class AppendCommandInstructionTest {
	...
	public void testValidate_1() {
		...
		String line = "Append something into /this";
		AppendCommandInstruction instr = new AppendCommandInstruction( this.context, line, 1 );
	...
	public void testValidate_2() {
		...
		String line = "append something into ";
		AppendCommandInstruction instr = new AppendCommandInstruction( this.context, line, 1 );
		List<ParsingError> errors = instr.validate();
	...
	public void testReplacement() {
		...
		String line = "append this into %TMP%/";
		AppendCommandInstruction instr = new AppendCommandInstruction( this.context, line, 1 );
		List<ParsingError> errors = instr.validate();
