...
public class ReplicateCommandInstructionTest {
	...
	public void testValidate_1() {
		...
		String line = "replicate /invalid as toto";
		ReplicateCommandInstruction instr = new ReplicateCommandInstruction( this.context, line, 1 );
	...
	public void testValidate_2() {
		...
		String line = "replicate /tomcat-vm as";
		ReplicateCommandInstruction instr = new ReplicateCommandInstruction( this.context, line, 1 );
		List<ParsingError> errors = instr.validate();
	...
	public void testValidate_4() {
		...
		String line = "replicate /tomcat-vm as !boo!";
		ReplicateCommandInstruction instr = new ReplicateCommandInstruction( this.context, line, 1 );
		List<ParsingError> errors = instr.validate();
	...
	public void testValidate_5() {
		...
		String line = "replicate /tomcat-vm/tomcat-server as toto";
		ReplicateCommandInstruction instr = new ReplicateCommandInstruction( this.context, line, 1 );
		List<ParsingError> errors = instr.validate();

		Assert.assertEquals( 1, errors.size());
		Assert.assertEquals( ErrorCode.CMD_NOT_A_ROOT_INSTANCE, errors.get( 0 ).getErrorCode());
	}
	...
	public void testValidate_6() {
		...
		String line = "replicate /tomcat-vm as toto";
		ReplicateCommandInstruction instr = new ReplicateCommandInstruction( this.context, line, 1 );
		List<ParsingError> errors = instr.validate();
	...
	public void testValidate_7() {
		...
		String line = "replicate invalid syntax";
		ReplicateCommandInstruction instr = new ReplicateCommandInstruction( this.context, line, 1 );
		List<ParsingError> errors = instr.validate();
	...
	public void testUpdateContext() {
		...
		String line = "replicate /tomcat-vm as vm-for-tomcat";
		ReplicateCommandInstruction instr = new ReplicateCommandInstruction( this.context, line, 1 );
