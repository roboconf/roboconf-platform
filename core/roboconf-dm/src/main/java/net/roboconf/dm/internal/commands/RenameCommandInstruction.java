 ...
 */
class RenameCommandInstruction implements ICommandInstruction {
	 ...
	 * @param instruction
	 */
	RenameCommandInstruction( ManagedApplication ma, String instruction ) {
		this.ma = ma;
	...
	public RoboconfError validate() {
		...
		else if( InstanceHelpers.hasChildWithThisName( this.ma.getApplication(), this.instance.getParent(), this.newInstanceName ))
			result = new RoboconfError( ErrorCode.EXEC_CMD_CONFLICTING_INSTANCE_NAME );
		else if( InstanceHelpers.findScopedInstance( this.instance ).getStatus() != InstanceStatus.NOT_DEPLOYED )
			result = new RoboconfError( ErrorCode.EXEC_CMD_APPLIABLE_TO_NOT_DEPLOYED_ONLY );
	...
	public void execute() throws CommandException {
		this.instance.setName( this.newInstanceName );
	}
}
