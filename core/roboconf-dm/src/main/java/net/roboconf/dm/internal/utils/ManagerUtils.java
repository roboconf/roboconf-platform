...
public final class ManagerUtils {
	 ...
	 * This method lists the available target and logs it.
	 */
	public static void listListeners( List<IDmListener> listeners, Logger logger ) {

		if( listeners.isEmpty()) {
			logger.info( "No listener was found in Roboconf's DM." );

		} else {
			StringBuilder sb = new StringBuilder( "Available listeners in Roboconf's DM: " );
			for( Iterator<IDmListener> it = listeners.iterator(); it.hasNext(); ) {
